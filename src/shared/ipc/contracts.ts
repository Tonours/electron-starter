...
export type RequestOf<K extends ContractKey> = z.input<
  (typeof contracts)[K]['requestSchema']
>;
export type ResponseEnvelopeOf<K extends ContractKey> = z.output<
  (typeof contracts)[K]['responseSchema']
>;
export type SuccessResponseDataOf<K extends ContractKey> = Extract<
