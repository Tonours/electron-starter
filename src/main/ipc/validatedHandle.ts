...
type SuccessDataFromContract<Contract extends IpcContract<ZodTypeAny, ZodTypeAny>> =
...
>(
  contract: Contract,
  handler: (payload: z.output<Contract['requestSchema']>) => Promise<SuccessDataFromContract<Contract>>
): void => {
